				...
				<div>
					<h1>Allgemeine Geschäftsbedingungen</h1>
						...
						<p>
							...
							Darüber hinaus akzeptieren Sie, dass DFX  jederzeit und ohne vorherige Ankündigung die Allgemeinen Geschäftsbedingungen ändern kann. Wenn Sie mit den Allgemeinen Geschäftsbedingungen nicht einverstanden sind, dürfen Sie nicht auf die Website zugreifen oder sie in jeglicher Weise nutzen.
						</p>
						<p>
						...
						<p>
							<h2>Urheberrecht und Warenzeichen</h2>
								...
								Mit den vorliegenden Bedingungen wird Ihnen nicht das Recht gewährt, den Namen „DFX ” oder die Markenzeichen, Logos, Domainnamen, sonstige charakteristische Markenzeichen und andere Eigentumsrechte von DFX  zu verwenden.
						</p>
						<p>
						...
						<h2>Vertraulichkeit in Bezug auf Benutzer-IDs und Passwörter</h2>
								...
								Sie haben zur Kenntnis genommen, dass Sie Ihre Verbindung zu den von DFX  angebotenen Identifikationsdiensten trennen müssen, bevor Sie Ihre Internetstation verlassen. Dazu müssen Sie alle Ihre Browserfenster schließen, die die Seite anzeigen.
						</p>
						<p>
							<h2>Ordnungsgemäße Nutzung der Website</h2>
								...
								einen Kaufauftrag zu erteilen, dessen Wert unter dem auf der Website von DFX  angegebenen Mindestbetrag liegt.
								...
								Sollten Sie eine dieser Maßnahmen ergreifen, behält sich DFX  das Recht vor, Ihnen den Zugang zur Website zu verweigern, selbst wenn Sie ein registrierter Kunde von DFX -Broker sind.
						</p>
						<p>
						...
						<p>
							<h2>Benutzer-Registrierung</h2>
								Die Nutzung der Finanzdienstleistungen von DFX  erfordert eine Registrierung auf der Website.
								...
								Die Vorlage und Validierung verschiedener Dokumente, auf die in diesen Allgemeinen Geschäftsbedingungen Bezug genommen wird, durch DFX  ist für den Kauf und Verkauf von Kryptowährungen sowie für die Umrechnung von Kryptowährungen erforderlich. Es gibt keine bereits bestehende Registrierungsgebühr. DFX  kann jede Registrierung ohne Angabe von Gründen ablehnen, jeden registrierten Nutzer ausschließen – u. a. im Falle von Betrug, Betrugsversuchen, gefälschten Wertpapieren oder gefälschten Zertifikaten – oder den Abschluss einer Transaktion ablehnen. Gesperrte Benutzer dürfen sich nicht erneut auf der Website registrieren. Falls sie dies dennoch tun, können diese Benutzer strafrechtlich verfolgt werden.
						...
						<p>
							<h2>Identifikationsstufe</h2>
								...
								Ein ordnungsgemäß ausgefülltes DFX -Registrierungsformular.
								...
								Hier finden Sie die Liste der gefährdeten Länder: <a href="https://DFX.com/products/crypto-exchange-api/high-risk-countries" target="_blank">Hoch-Risiko Laender</a>

								Experte
								Limit pro Transaktion	500.000 Schweizer Franken (CHF)
								Jahreslimit	keines
								Wie man:Wenn Sie ein jährliches Transaktionsvolumen von mehr als 50.000 Schweizer Franken (CHF) erreichen, können Sie DFX  über den technischen Support bitten, ein Upgrade Ihres Accounts von der Stufe „Erweitert“ auf „Experte“ vorzunehmen. DFX  wird Ihre Kundendatei analysieren und Ihre Anfrage annehmen oder ablehnen.

								Erforderliche Informationen: Zusätzliche Verifizierungsinformationen sind erforderlich, wie z. B. ein Nachweis über die Herkunft von Geldern mittels einer Steuererklärung, Gewinn- und Verlustrechnung, Kontoauszügen etc. Welche zusätzlichen Informationen DFX  anfordert, hängt vom Profil des Benutzers ab und kann sich ändern. Es gilt das gleiche Verfahren zur Überprüfung, wie in der Stufe „Erweitert“ beschrieben (Bestätigung per SMS, Videokonferenz).

								Änderungen Ihrer personenbezogenen Daten sind DFX  unverzüglich mitzuteilen. Die angegebenen Daten müssen vollständig und jederzeit gültig sein.

								DFX  wird Ihr Passwort niemals an Dritte weitergeben und Sie niemals per E-Mail oder Telefon nach derartigen Informationen fragen. Eine solche Anfrage ist zu ignorieren und DFX  zu melden.
								...
								Sie können Ihren Account jederzeit löschen, indem Sie eine Anfrage an den technischen Support von DFX  stellen.

								DFX  ist verpflichtet, Aufzeichnungen über Transaktionen zehn Jahre lang aufzubewahren. Dieser Zeitraum beginnt mit dem Ende der Ausführung der Transaktionen oder, wenn mehr als eine Transaktion ein Ganzes bildet, mit dem Ende der letzten Transaktion. Wenn Sie also Transaktionen getätigt haben, kann Ihr Konto nicht gelöscht werden. Es wird jedoch deaktiviert.
						</p>
						<p>
						...
						<h2>Bedingungen für die Konvertierung von Kryptowährungen</h2>
								...
								Die Preise verstehen sich in der für die Konvertierung zulässigen Kryptowährung und beinhalten die Schweizer MWST (falls zutreffend). Die Konvertierung muss durch Überweisung der Kryptowährung an eine von DFX  im Rahmen der Konvertierung angegebene Einwegadresse erfolgen. Sie haben 10 Minuten Zeit, um die Überweisung abzuschließen.

								Die Gebühr für die Konvertierung der Kryptowährung ist im Basispreis enthalten.

								Konvertierungsaufträge werden von DFX  innerhalb einer Frist von fünf Werktagen bearbeitet. Diese Frist beginnt mit dem Eingang des Auftrags bei DFX . Wird der Konvertierungsauftrag nicht innerhalb der oben genannten Frist bearbeitet, sind Sie verpflichtet, DFX  unverzüglich zu informieren. Wenn Sie dieser Verpflichtung nicht nachkommen, können Sie keine Ansprüche bezüglich der Änderung des Wechselkurses erheben.
						</p>
						<p>
							<h2>Ihre Due Diligence bei der Auftragserteilung (Kauf, Verkauf oder Konvertierung):</h2>
								...
								Die Preise verstehen sich in der für die Konvertierung zulässigen Kryptowährung und beinhalten die Schweizer Mehrwertsteuer (falls zutreffend). Die Konvertierung muss durch Überweisung der Kryptowährung an eine von DFX  im Rahmen der Konvertierung angegebene Einwegadresse erfolgen. Sie haben 10 Minuten Zeit, um die Überweisung abzuschließen.

								Die Gebühr für die Konvertierung der Kryptowährung ist im Basispreis enthalten.

								Konvertierungsaufträge werden von DFX  innerhalb einer Frist von fünf Werktagen bearbeitet. Diese Frist beginnt mit dem Eingang des Auftrags bei DFX . Wird der Konvertierungsauftrag nicht innerhalb der oben genannten Frist bearbeitet, sind Sie verpflichtet, DFX  unverzüglich zu informieren.
								...
								Mindestbetrag
								Sie dürfen keinen Kaufauftrag erteilen, dessen Wert unter dem auf der Website von DFX  angegebenen Mindestbetrag liegt.
								...
								Differenz zwischen dem im Kaufauftrag angegebenen Betrag und dem tatsächlich von DFX  erhaltenen Betrag
								Kaufauftrag angegeben haben. Wenn der von Ihnen gezahlte Betrag unter oder über dem in Ihrem Kaufauftrag angegebenen Betrag liegt, wird der Gegenwert in Kryptowährung von DFX  automatisch im Rahmen Ihrer Kontingente und der auf der Website von DFX  angegebenen Mindestbeträge angepasst. Die Bankgebühren gehen zu Ihren Lasten. Möglicherweise werden Ihnen auch Verwaltungsgebühren in Rechnung gestellt.
								Anzugebende Adresse
								DFX  eine Kryptowährungsadresse mitteilen, die gültig und für Sie frei verfügbar ist. Wenn Sie einen Kaufauftrag erteilen und DFX  eine Adresse zur Verfügung stellen, die ungültig ist oder nicht Ihnen gehört – wie z. B. eine Initial Coin Offering (ICO)-Adresse – gehen Ihre Gelder verloren. DFX  kann Nachforschungen anstellen, um zu versuchen, verlorene Kryptowährungen zurückzuerlangen, ist jedoch nicht dazu verpflichtet. Diese Nachforschungen liegen im alleinigen Ermessen von DFX  und können durchgeführt werden, wenn es sich um große Geldbeträge handelt. Sie müssen die Kosten für die Nachforschungen tragen, die der technischen Komplexität und dem Zeitaufwand für die Nachforschungen Rechnung tragen.
								Grund für die Zahlung
								Sie den Grund für Ihre Zahlung angeben, indem Sie folgende Art von Referenz verwenden: „DFX .com XXXX-XXXXX“, wobei die „X“ Großbuchstaben oder Zahlen darstellen. Wenn der oben genannte Verweis nicht auf dem Zahlungsauftrag erscheint, wird Ihr Geld zurückerstattet. Die Bankgebühren werden Ihnen in Rechnung gestellt, und Ihnen kann auch eine zusätzliche Verwaltungsgebühr berechnet werden.
								Stornierung des Kaufauftrags
								Kaufaufträge können storniert werden, solange die Währung noch nicht bei DFX  eingegangen ist. Wenn Sie die Währung gesendet haben, DFX  sie aber noch nicht erhalten hat, wird Ihr Geld zurückerstattet. Die Bankgebühren werden Ihnen in Rechnung gestellt, und Ihnen kann auch eine zusätzliche Verwaltungsgebühr berechnet werden.
								Wenn sie einen kaufauftrag erteilen
								Mindestbetrag
								Sie dürfen keinen Verkaufsauftrag erteilen, dessen Wert unter dem auf der Website von DFX  angegebenen Mindestbetrag liegt.
								...
								Sie müssen die Zahlung durch Überweisung der Kryptowährung an eine von DFX  angegebene Einwegadresse vornehmen. Wenn Sie die Kryptowährung an eine andere als die von DFX  angegebene Adresse senden, gehen Ihre Gelder verloren, da DFX  die privaten Schlüssel für diese Adressen nicht besitzt. DFX  kann Nachforschungen anstellen, um zu versuchen, verlorene Kryptowährungen zurückzuerlangen, ist jedoch nicht dazu verpflichtet. Diese Nachforschungen liegen im alleinigen Ermessen von DFX  und können durchgeführt werden, wenn es sich um große Geldbeträge handelt. Sie müssen die Kosten für die Nachforschungen tragen, die der technischen Komplexität und dem Zeitaufwand für die Nachforschungen Rechnung tragen.
								DFX  mitzuteilende Bankverbindung
								Um Ihre Währung zu erhalten, müssen Sie DFX  die Referenz eines gültigen Bankkontos angeben, das Ihnen gehört. Wenn Sie DFX  eine falsche Bankverbindung oder eine Bankverbindung mitteilen, die einem Dritten gehört, gehen Ihre Gelder verloren. DFX  kann Nachforschungen anstellen, um zu versuchen, verlorene Kryptowährungen zurückzuerlangen, ist jedoch nicht dazu verpflichtet. Diese Nachforschungen liegen im alleinigen Ermessen von DFX  und können durchgeführt werden, wenn es sich um große Geldbeträge handelt. Sie müssen die Kosten für die Nachforschungen tragen, die der technischen Komplexität und dem Zeitaufwand für die Nachforschungen Rechnung tragen.
								...
								Mindestbetrag
								Sie dürfen keinen Konvertierungsauftrag erteilen, dessen Wert unter dem auf der Website von DFX  angegebenen Mindestbetrag liegt.
								Von DFX  angegebene Adresse
								Sie müssen die Konvertierung durchführen, indem Sie die Kryptowährung an eine von DFX  angegebene Einwegadresse übertragen. Wenn Sie Kryptowährung an eine andere Adresse als die von DFX  angegebene senden, gehen Ihre Gelder verloren. DFX  kann Nachforschungen anstellen, um zu versuchen, verlorene Kryptowährungen zurückzuerlangen, ist jedoch nicht dazu verpflichtet. Diese Nachforschungen liegen im alleinigen Ermessen von DFX  und können durchgeführt werden, wenn es sich um große Geldbeträge handelt. Sie müssen die Kosten für die Nachforschungen tragen, die der technischen Komplexität und dem Zeitaufwand für die Nachforschungen Rechnung tragen.
								DFX  mitzuteilende Adresse
								Sie müssen DFX  eine Kryptowährungsadresse mitteilen, die gültig und für Sie frei verfügbar ist. Wenn Sie einen Konvertierungsauftrag erteilen und DFX  eine Adresse mitteilen, die ungültig ist oder einem Dritten gehört – wie z. B. eine Initial Coin Offering (ICO)-Adresse – gehen Ihre Gelder verloren. DFX  kann Nachforschungen anstellen, um zu versuchen, verlorene Kryptowährungen zurückzuerlangen, ist jedoch nicht dazu verpflichtet. Diese Nachforschungen liegen im alleinigen Ermessen von DFX  und können durchgeführt werden, wenn es sich um große Geldbeträge handelt. Sie müssen die Kosten für die Nachforschungen tragen, die der technischen Komplexität und dem Zeitaufwand für die Nachforschungen Rechnung tragen.
								Frist für die Zahlung der Kryptowährung
								Sie müssen die Zahlung in Kryptowährung innerhalb von 10 Minuten nach Erteilung des Konvertierungsauftrags vornehmen. Wenn Sie die Zahlung nicht innerhalb dieser Frist leisten, wird der Gegenwert der Kryptowährung automatisch neu berechnet und Sie können keine Ansprüche bezüglich der Änderung des Wechselkurses geltend machen. Darüber hinaus sind die Ausführung des Auftrags und die Wiedererlangung von Geldern nicht garantiert.
								Netzwerkgebühren
								Wenn die vom Absender der Kryptowährung (dem Kunden) gewählten Netzwerkgebühren zu niedrig sind oder wenn die Transaktion nicht innerhalb einer Stunde nach Erteilung des Konvertierungsauftrags auf der entsprechenden Blockchain bestätigt wird, behält DFX  sich das Recht vor, den Wechselkurs zum Zeitpunkt der Bestätigung der Transaktion auf der Blockchain neu zu berechnen.
								Stornierung des Konvertierungsauftrag
								Konvertierungsaufträge können storniert werden, solange die Kryptowährung noch nicht bei DFX  eingegangen ist.
						</p>
						<p>
